...
4. [**Eventhouse](<https://learn.microsoft.com/fabric/real-time-intelligence/eventhouse>)**: The Eventhouse can host multiple KQL Databases for easier management. It will store relational data from an operational SQL DB, levergage shortcuts and automate transformations in real-time. 
